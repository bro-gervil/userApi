...
class EntreeStockModel extends Model
{
    ...
    protected $allowedFields    = ['id','id_prod_stock','id_prod','qtite_entree','date','created_at'];
    ...
    public function entreeStock($data){
        $db= \Config\Database::connect();
        esc($data); 
        $query1=$this->$db->insert('entree_stock',esc($data));
        return $query1;
    }
