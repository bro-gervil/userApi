...
class Auth extends ShieldAuth//BaseConfig
{
    /**
     * ////////////////////////////////////////////////////////////////////
     * AUTHENTICATION
    ...
    public array $views = [
        ...
        'forgotPassword'              => '\CodeIgniter\Shield\Views\forgotPassword',
    ...
    public array $actions = [
        'register' => \CodeIgniter\Shield\Authentication\Actions\EmailActivator::class,
        'login'    => null, //ou \CodeIgniter\Shield\Authentication\Actions\Email2FA::class
    ];
