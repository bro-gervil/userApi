(function ($) {
        $.fn.tblToExcel = function (nom_poste) {
            var elm = true;
            if (this.length > 1) {
            ...
            var tableToExcel = (function () {
                var timestamp = new Date().getTime(); // Obtenir l'horodatage actuel
                var i = 0;
                ...
                return function (table, name) {
                    ...
                    if (elm) {
                        ...
                        $('#tbl-tnv-excel').append('<a id="tbl-tnv-anch" style="background-color: #4CAF50;border: none;\n' +
                            ...
                            'font-size: 16px;" href='+xl+' download="Bon_approvision°_'+nom_poste+'_'+timestamp+'"</a>');
                    }
                }
            })();
